...
### `nudge` ✅ 已实现
**用户故事**: 作为讲师，我知道"未交"这个判断系统已经算得出来，但催不催、催了没有全靠我自己记；我想要一个页面告诉我"这门课谁还没交、逾期几天、催过没有"，系统帮我按已催次数推荐合适语气的催促文案，我看一眼改改就能发，发完点一下标记，下次不会漏催也不会重复催；跳过的人我还想留着看，跳错了能反悔，不想导出名单里混进已经跳过的人
**覆盖需求**:
